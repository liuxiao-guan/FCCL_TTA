...
if __name__ =='__main__':
    ...
    # For cigar10 scenario
    # net_dataidx_map = partition_data(dataset=Private_Dataset_Name,datadir=Private_Dataset_Dir,partition='noniid', n_parties=10,logger=logger)
    # For Digits scenario
